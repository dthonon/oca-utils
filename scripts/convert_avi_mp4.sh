...
for f in ${1-*.AVI}; do
    ...
    exiftool -srcfile %d%f.%e.xmp -srcfile @ \
    #     -Categories -TagsList -LastKeywordXMP -HierarchicalSubject -CatalogSets -Subject -Tagsfromfile $f $g
    exiftool -Tagsfromfile $f.xmp $g.xmp
